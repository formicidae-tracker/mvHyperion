...
//-------------------------------------------------------------------------------------------
{
    ...
    TPipe*                           interrupt_result_pipe; ///< resultqueue to save interruptstatus for handling in our DPC
    struct mux_controller_sequence  mux_seq;
    ...
    void ( *set_hrtc_ram )( struct hyperion* phyperion, struct transfer_parameter* tp );
    ...
    TKSemaphore*                     sema_message_received;
